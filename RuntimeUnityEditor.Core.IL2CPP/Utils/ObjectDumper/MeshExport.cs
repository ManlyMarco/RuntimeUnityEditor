        ...
        private static class MeshExtensions
        {
            ...
            private class Vertices
            {
                ...
                public Vertices(Mesh mesh)
                {
                    ...
                    {
                        verts = new Il2CppSystem.Collections.Generic.List<Vector3>(mesh.vertices.Pointer);
                    }
                    ...
                    {
                        uv1 = new Il2CppSystem.Collections.Generic.List<Vector2>(mesh.uv.Pointer);
                    }
                    ...
                    {
                        uv2 = new Il2CppSystem.Collections.Generic.List<Vector2>(mesh.uv2.Pointer);
                    }
                    ...
                    {
                        uv3 = new Il2CppSystem.Collections.Generic.List<Vector2>(mesh.uv3.Pointer);
                    }
                    ...
                    {
                        uv4 = new Il2CppSystem.Collections.Generic.List<Vector2>(mesh.uv4.Pointer);
                    }
                    ...
                    {
                        normals = new Il2CppSystem.Collections.Generic.List<Vector3>(mesh.normals.Pointer);
                    }
                    ...
                    {
                        tangents = new Il2CppSystem.Collections.Generic.List<Vector4>(mesh.tangents.Pointer);
                    }
                    ...
                    {
                        colors = new Il2CppSystem.Collections.Generic.List<Color32>(mesh.colors32.Pointer);
                    }
                    ...
                    {
                        boneWeights = new Il2CppSystem.Collections.Generic.List<BoneWeight>(mesh.boneWeights.Pointer);
                    }
                }
                ...
                public void AssignTo(Mesh target)
                {
                    ...
                    if (boneWeights != null) target.boneWeights = (Il2CppStructArray<BoneWeight>)boneWeights.ToArray();
                }
            }
        }
    }
