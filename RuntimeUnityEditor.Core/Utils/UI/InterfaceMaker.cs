...
namespace RuntimeUnityEditor.Core.UI
{
    ...
    public static class InterfaceMaker
    {
        ...
        private static GUISkin CreateSkin()
        {
            ...
            newSkin.window.padding.Set(int.Parse(windowPaddings[0]), int.Parse(windowPaddings[1]), int.Parse(windowPaddings[2]), int.Parse(windowPaddings[3]));
            ...
            newSkin.window.border.Set(int.Parse(windowBorders[0]), int.Parse(windowBorders[1]), int.Parse(windowBorders[2]), int.Parse(windowBorders[3]));
            ...
            newSkin.button.padding.Set(int.Parse(buttonPaddings[0]), int.Parse(buttonPaddings[1]), int.Parse(buttonPaddings[2]), int.Parse(buttonPaddings[3]));
