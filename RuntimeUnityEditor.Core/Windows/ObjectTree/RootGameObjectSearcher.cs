...
namespace RuntimeUnityEditor.Core.ObjectTree
{
    ...
    public class RootGameObjectSearcher
    {
        ...
        {
#if IL2CPP
            return Resources.FindObjectsOfTypeAll(Il2CppInterop.Runtime.Il2CppType.Of<Transform>())
                .Select(x => x.Cast<Transform>())
        ...
        public bool SearchReferences(object objInstance)
        {
            ...
            var results = GetRootObjects()
                             .SelectMany(x => x.AbstractGetAllComponentsInChildren(true))
        ...
        {
            if (_indexingCo == null)
                _indexingCo = RuntimeUnityEditorCore.PluginObject.AbstractStartCoroutine(IndexObjectsCoWrapper());
        }
        ...
        private IEnumerator IndexObjectsCoWrapper()
        {
            var enumerator = IndexObjectsCo();
            do
            {
                try
                {
                ...
                {
                    RuntimeUnityEditorCore.Logger.Log(LogLevel.Error, "Indexing failed: " + e);
                    Console.WriteLine(e);
                    break;
                }
        ...
        private static readonly HashSet<string> _nameBlacklist = new HashSet<string>
        {
            ...
            // NavMeshAgent properties often spewing errors
            "destination", "remainingDistance",
#if IL2CPP  // Il2CPP nonsense, crashes in SVS
        ...
        private sealed class SearchStrings
        {
            ...
            public static SearchStrings Create(GameObject obj, bool searchProperties)
            {
                ...
                var components = obj.AbstractGetAllComponents().Where(c => c).ToArray();
